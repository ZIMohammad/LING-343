...
book_load2 <- function(id_num) {
  gutenberg_download(id_num, mirror = "...") |>
  unnest_tokens(word, text) |> anti_join(stop_words) |> select(word)
}
```
...
tristram_shandy <- book_load(39270)
divine_comedy <- book_load(8800)
inspector <- book_load(3735)
  # Epics
illiad <- book_load(6130)
odyssey <- book_load(3160)
gilgamesh <- book_load(11000)
paradise_lost <- book_load(20)
  # Tragedies
othello <- book_load(1531)
frankenstein <- book_load(41445)
